...
export const envSchema = z.object({
  ...
  GEO_CATALOG_BASE_URL: httpUrl.default('https://countriesnow.space/api/v0.1/countries'),
  GEO_CATALOG_TIMEOUT_MS: z.coerce.number().int().min(1_000).max(30_000).default(10_000),
  GEO_CATALOG_CACHE_TTL_MS: z.coerce.number().int().min(60_000).max(86_400_000).default(3_600_000),
